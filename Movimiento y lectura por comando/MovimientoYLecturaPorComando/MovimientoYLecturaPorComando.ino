...
/**
   Realiza el movimiento del robot, hace escritura digital a partir de los pines impuestos como variables m1direction, m2direction con valor izq en m1 y der en m2 como parámetro
...
/**
   Llama a los métodos correspondientes para el movimiento hacia adelante, lectura izquierda y derecha,
   movimiento izquierda, lectura izquierda y derecha, movimiento derecha, lectura izquierda y derecha,
   y reversa, lectura izquierda y derecha con un tiempo variable tiempo y una velocidad máxima de 255 (2^8-1), con un delay asignado con la variable delayP
*/
